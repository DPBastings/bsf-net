...
# IPv4 address
```cpp
class address<domain::domain::ipv4>: public addressBase;
```
Class representing an Internet Protocol v4 address.
## Methods
### Constructors
```cpp
address<domain::domain::ipv4>::address()                                  // 1
address<domain::domain::ipv4>::address(in_port_t port, uint32_t address); // 2
```
...
```cpp
address<domain::domain::ipv4>::operator std::string() const; // 1
```
...
```cpp
uint32_t
address<domain::domain::ipv4>::address() const noexcept;
```
Return the IPv4 address.
#### port
```cpp
in_port_t
address<domain::domain::ipv4>::port() const noexcept;
```
Return the port.
